...
import { mockIngredients, mockRecipes, mockSuggestions } from '../mockData';
...
const Dashboard = () => {
    ...
    const fetchDashboardData = () => {
        ...
        setTimeout(() => {
            ...
            setExpiringIngredients(mockIngredients.filter(i => new Date(i.itemAdded) < new Date('2024-03-16')));
            setRecipes(mockRecipes);
            setSuggestions(mockSuggestions);

            // Calculate stats
            const vegetableCount = mockIngredients.filter(i => i.is_vegetable_or_fruit).length;
            const otherCount = mockIngredients.length - vegetableCount;
